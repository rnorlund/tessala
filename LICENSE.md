...
Required Notice: Copyright © 2026 rnorlund (Tessala)
...
This project bundles **tactile.js** (`vendor/tactile.js`,
`vendor/tactile.global.js`) by Craig S. Kaplan, used under the
**BSD 3-Clause License**, Copyright © 2018 Craig S. Kaplan. Its
license terms are retained in the source files and apply to those
files only.
